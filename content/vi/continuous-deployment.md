...
Triển khai liên tục (Continuous Deployment), thường được viết tắt là CD,là 1 bước xa hơn [phân phối liên tục](/continuous-delivery/)
...
và quy trình CD tự động triển khai các thay đổi mã nguồn qua các môi trường của tổ chức từ kiểm thử đến sản xuất.

## Vấn đề nó giải quyết

Phát hành các phiên bản phần mềm mới có thể là một quá trình tốn nhiều công sức và dễ xảy ra lỗi.
Đây cũng thường là điều mà các tổ chức chỉ muốn thực hiện không thường xuyên để tránh các sự cố sản xuất
...
CD làm cho các nhóm vận hành những gì CI đã làm cho các nhóm phát triển.
Cụ thể, nó buộc các nhóm vận hành phải tự động hóa các phần triển khai sản xuất đau đớn và dễ xảy ra lỗi, giảm rủi ro tổng thể.
Nó cũng giúp các tổ chức tốt hơn trong việc chấp nhận và thích ứng với các thay đổi sản xuất, dẫn đến tính ổn định cao hơn.
