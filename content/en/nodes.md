...
In [cloud computing](/cloud_computing/), a node can be a physical computer, 
...
To address this, developers started creating [distributed applications](/distributed_apps/) where each process runs on its own node. 
