...
Manual provisioning cannot meet the responsiveness and scale requirements of [cloud native applications](/cloud_native_apps/). 
...
also allows them to manage their data center in a [CI](/continuous_integration/)/[CD](/continuous_delivery/) pipeline, 
