...
**テクノロジー** と **コンセプト** のカテゴリの定義には、3つの副題があります： 

- **これは何ですか** : 私たちが話していることについて、短く明確な概要を提供します。
...
**例**：[サービスメッシュの定義](/service-mesh/)の「これは何ですか」セクションを見てみましょう。
...
詳しくは、[貢献の仕方](/contribute/) ドキュメントをご覧ください。
...
(チャンネルがある場所と方法については、[貢献の仕方](/contribute/) ドキュメントを参照してください)。
