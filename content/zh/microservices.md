...
简而言之，微服务指的是一种应用架构模式，通常与 [单体应用](/zh/monolithic_apps/) 形成对比。

## 解决的问题

微服务是对单体应用所带来的挑战的一种回应。一般来说，一个应用程序的不同部分需要分别进行 [扩展](/zh/scalability/)。
...
虽然微服务解决了许多问题，但它们也产生了运营开销——你需要部署和跟踪的东西增加了一个数量级或更多。许多 [云原生技术](/zh/cloud_native_tech/) 旨在使微服务更容易部署和管理。
