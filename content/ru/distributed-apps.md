...
Этот подход также позволяет воспользоваться способами масштабирования, которые недоступны монолитам, а именно [горизонтальным масштабированием](horizontal-scaling/). 
