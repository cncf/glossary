...
При горизонтальном масштабировании мы добавим еще три инстанса (узла) с 4 ГБ ОЗУ, при вертикальном увеличим объем ОЗУ до 16 ГБ на имеющемся инстансе.
...
то два узла будут обрабатывать 2 тыс., три узла — 3 тыс. запросов (при условии, что узлы одинаковые) и т.д. 
