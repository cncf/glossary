...
Одно из них обслуживает production-трафик (в нем работает текущая версия, с которой взаиодействуют пользователи), а другое в это время обновляется.
...
разные версии которого несовместимы (т. е. приходится обновлять сразу все компоненты).
