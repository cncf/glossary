...
Чтобы обновить автономное приложение, пользователям приходилось бы загружать и устанавливать последнюю версию. 
Представьте, что для просмотра каталога товаров Amazon необходимо сначала загрузить его себе на компьютер!

## Как именно решает проблему

Когла логика приложения реализована на удаленном сервере или в сервисе, операторы могут обновлять ее, 
