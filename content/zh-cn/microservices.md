...
简而言之，微服务指的是一种应用架构模式，通常与 [单体应用](/zh-cn/monolithic_apps/) 形成对比。
...
虽然微服务解决了许多问题，但它们也产生了运营开销——你需要部署和跟踪的东西增加了一个数量级或更多。许多 [云原生技术](/zh-cn/cloud_native_tech/) 旨在使微服务更容易部署和管理。
