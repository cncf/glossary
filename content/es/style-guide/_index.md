...
Asegúrese de que las definiciones sean explicadas en términos simples y no asuma conocimientos técnicos. Más sobre esto se encuentra a continuación en la sección [Definición](#definition) y en la [Guía de estilo para lengua de señas](#sign-language-style-guide).
